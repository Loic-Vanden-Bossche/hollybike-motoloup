...
class EventJourneyStepNotFoundException(message: String? = null) : RuntimeException(message)
class DuplicateEventJourneyStepException(message: String? = null) : RuntimeException(message)
