...
/// Adds pattern-matching-related methods to [EventCandidate].
extension EventCandidatePatterns on EventCandidate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EventCandidate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EventCandidate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EventCandidate value)  $default,){
final _that = this;
switch (_that) {
case _EventCandidate():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EventCandidate value)?  $default,){
final _that = this;
switch (_that) {
case _EventCandidate() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String username, @JsonKey(name: "is_owner")  bool isOwner, @JsonKey(name: "profile_picture")  String? profilePicture, @JsonKey(name: "profile_picture_key")  String? profilePictureKey, @JsonKey(name: "event_role")  EventRole? eventRole)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EventCandidate() when $default != null:
return $default(_that.id,_that.username,_that.isOwner,_that.profilePicture,_that.profilePictureKey,_that.eventRole);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String username, @JsonKey(name: "is_owner")  bool isOwner, @JsonKey(name: "profile_picture")  String? profilePicture, @JsonKey(name: "profile_picture_key")  String? profilePictureKey, @JsonKey(name: "event_role")  EventRole? eventRole)  $default,) {final _that = this;
switch (_that) {
case _EventCandidate():
return $default(_that.id,_that.username,_that.isOwner,_that.profilePicture,_that.profilePictureKey,_that.eventRole);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String username, @JsonKey(name: "is_owner")  bool isOwner, @JsonKey(name: "profile_picture")  String? profilePicture, @JsonKey(name: "profile_picture_key")  String? profilePictureKey, @JsonKey(name: "event_role")  EventRole? eventRole)?  $default,) {final _that = this;
switch (_that) {
case _EventCandidate() when $default != null:
return $default(_that.id,_that.username,_that.isOwner,_that.profilePicture,_that.profilePictureKey,_that.eventRole);case _:
  return null;
