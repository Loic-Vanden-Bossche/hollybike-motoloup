...
/// Adds pattern-matching-related methods to [MinimalJourney].
extension MinimalJourneyPatterns on MinimalJourney {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MinimalJourney value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MinimalJourney() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MinimalJourney value)  $default,){
final _that = this;
switch (_that) {
case _MinimalJourney():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MinimalJourney value)?  $default,){
final _that = this;
switch (_that) {
case _MinimalJourney() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? file,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MinimalJourney() when $default != null:
return $default(_that.id,_that.file,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss,_that.previewImage,_that.previewImageKey);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? file,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey)  $default,) {final _that = this;
switch (_that) {
case _MinimalJourney():
return $default(_that.id,_that.file,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss,_that.previewImage,_that.previewImageKey);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? file,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey)?  $default,) {final _that = this;
switch (_that) {
case _MinimalJourney() when $default != null:
return $default(_that.id,_that.file,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss,_that.previewImage,_that.previewImageKey);case _:
  return null;
