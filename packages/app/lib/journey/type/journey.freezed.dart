...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String? file, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey,  MinimalUser creator,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Journey() when $default != null:
return $default(_that.id,_that.name,_that.file,_that.createdAt,_that.previewImage,_that.previewImageKey,_that.creator,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String? file, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey,  MinimalUser creator,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss)  $default,) {final _that = this;
switch (_that) {
case _Journey():
return $default(_that.id,_that.name,_that.file,_that.createdAt,_that.previewImage,_that.previewImageKey,_that.creator,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String? file, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'preview_image')  String? previewImage, @JsonKey(name: 'preview_image_key')  String? previewImageKey,  MinimalUser creator,  Position? start,  Position? end,  Position? destination,  int? totalDistance,  int? minElevation,  int? maxElevation,  int? totalElevationGain,  int? totalElevationLoss)?  $default,) {final _that = this;
switch (_that) {
case _Journey() when $default != null:
return $default(_that.id,_that.name,_that.file,_that.createdAt,_that.previewImage,_that.previewImageKey,_that.creator,_that.start,_that.end,_that.destination,_that.totalDistance,_that.minElevation,_that.maxElevation,_that.totalElevationGain,_that.totalElevationLoss);case _:
  return null;
