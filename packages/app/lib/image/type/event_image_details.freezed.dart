...
/// Adds pattern-matching-related methods to [EventImageDetails].
extension EventImageDetailsPatterns on EventImageDetails {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EventImageDetails value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EventImageDetails() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EventImageDetails value)  $default,){
final _that = this;
switch (_that) {
case _EventImageDetails():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EventImageDetails value)?  $default,){
final _that = this;
switch (_that) {
case _EventImageDetails() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isOwner,  MinimalUser owner,  MinimalEvent event,  Position? position, @JsonKey(name: "taken_date_time")  DateTime? takenDateTime, @JsonKey(name: "uploaded_date_time")  DateTime uploadDateTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EventImageDetails() when $default != null:
return $default(_that.isOwner,_that.owner,_that.event,_that.position,_that.takenDateTime,_that.uploadDateTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isOwner,  MinimalUser owner,  MinimalEvent event,  Position? position, @JsonKey(name: "taken_date_time")  DateTime? takenDateTime, @JsonKey(name: "uploaded_date_time")  DateTime uploadDateTime)  $default,) {final _that = this;
switch (_that) {
case _EventImageDetails():
return $default(_that.isOwner,_that.owner,_that.event,_that.position,_that.takenDateTime,_that.uploadDateTime);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isOwner,  MinimalUser owner,  MinimalEvent event,  Position? position, @JsonKey(name: "taken_date_time")  DateTime? takenDateTime, @JsonKey(name: "uploaded_date_time")  DateTime uploadDateTime)?  $default,) {final _that = this;
switch (_that) {
case _EventImageDetails() when $default != null:
return $default(_that.isOwner,_that.owner,_that.event,_that.position,_that.takenDateTime,_that.uploadDateTime);case _:
  return null;
