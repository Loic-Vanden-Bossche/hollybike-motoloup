...
/// Adds pattern-matching-related methods to [UpdatePassword].
extension UpdatePasswordPatterns on UpdatePassword {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpdatePassword value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpdatePassword() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpdatePassword value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpdatePassword value)?  $default,){
final _that = this;
switch (_that) {
case _UpdatePassword() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'old_password')  String oldPassword, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'new_password_again')  String newPasswordAgain)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdatePassword() when $default != null:
return $default(_that.oldPassword,_that.newPassword,_that.newPasswordAgain);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'old_password')  String oldPassword, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'new_password_again')  String newPasswordAgain)  $default,) {final _that = this;
switch (_that) {
case _UpdatePassword():
return $default(_that.oldPassword,_that.newPassword,_that.newPasswordAgain);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'old_password')  String oldPassword, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'new_password_again')  String newPasswordAgain)?  $default,) {final _that = this;
switch (_that) {
case _UpdatePassword() when $default != null:
return $default(_that.oldPassword,_that.newPassword,_that.newPasswordAgain);case _:
  return null;
