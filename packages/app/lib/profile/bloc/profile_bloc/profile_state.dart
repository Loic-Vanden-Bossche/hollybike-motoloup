...
class UpdateLoadEventProfileState extends ProfileState {
  UpdateLoadEventProfileState({
    ...
    UserLoadEvent? userLoadEvent,
         ...
         usersLoad: oldState.usersLoad.copyUpdatedFromNullable(userLoadEvent),
...
class InvalidateProfileState extends ProfileState {
  InvalidateProfileState({
    ...
    required ProfileIdentifier profileIdentifier,
         ...
         profilesLoad:
             oldState.profilesLoad.where((profile) {
               ...
               final isUser =
                   isSuccess && profile.profile.id == profileIdentifier.id;
         ...
         usersLoad:
             profileIdentifier.id == null
                 ? oldState.usersLoad
                 : oldState.usersLoad
                     .where(
                       (user) =>
                           !(user.observerSession ==
                                   profileIdentifier.session &&
