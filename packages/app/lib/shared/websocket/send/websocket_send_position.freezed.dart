...
/// Adds pattern-matching-related methods to [WebsocketSendPosition].
extension WebsocketSendPositionPatterns on WebsocketSendPosition {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebsocketSendPosition value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebsocketSendPosition() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebsocketSendPosition value)  $default,){
final _that = this;
switch (_that) {
case _WebsocketSendPosition():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebsocketSendPosition value)?  $default,){
final _that = this;
switch (_that) {
case _WebsocketSendPosition() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  double latitude,  double longitude,  double altitude,  double heading, @JsonKey(name: "acceleration_x")  double accelerationX, @JsonKey(name: "acceleration_y")  double accelerationY, @JsonKey(name: "acceleration_z")  double accelerationZ,  DateTime time,  double speed, @JsonKey(name: "speed_accuracy")  double speedAccuracy,  double accuracy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebsocketSendPosition() when $default != null:
return $default(_that.type,_that.latitude,_that.longitude,_that.altitude,_that.heading,_that.accelerationX,_that.accelerationY,_that.accelerationZ,_that.time,_that.speed,_that.speedAccuracy,_that.accuracy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  double latitude,  double longitude,  double altitude,  double heading, @JsonKey(name: "acceleration_x")  double accelerationX, @JsonKey(name: "acceleration_y")  double accelerationY, @JsonKey(name: "acceleration_z")  double accelerationZ,  DateTime time,  double speed, @JsonKey(name: "speed_accuracy")  double speedAccuracy,  double accuracy)  $default,) {final _that = this;
switch (_that) {
case _WebsocketSendPosition():
return $default(_that.type,_that.latitude,_that.longitude,_that.altitude,_that.heading,_that.accelerationX,_that.accelerationY,_that.accelerationZ,_that.time,_that.speed,_that.speedAccuracy,_that.accuracy);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  double latitude,  double longitude,  double altitude,  double heading, @JsonKey(name: "acceleration_x")  double accelerationX, @JsonKey(name: "acceleration_y")  double accelerationY, @JsonKey(name: "acceleration_z")  double accelerationZ,  DateTime time,  double speed, @JsonKey(name: "speed_accuracy")  double speedAccuracy,  double accuracy)?  $default,) {final _that = this;
switch (_that) {
case _WebsocketSendPosition() when $default != null:
return $default(_that.type,_that.latitude,_that.longitude,_that.altitude,_that.heading,_that.accelerationX,_that.accelerationY,_that.accelerationZ,_that.time,_that.speed,_that.speedAccuracy,_that.accuracy);case _:
  return null;
