...
/// Adds pattern-matching-related methods to [WebsocketEventUpdated].
extension WebsocketEventUpdatedPatterns on WebsocketEventUpdated {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebsocketEventUpdated value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebsocketEventUpdated() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebsocketEventUpdated value)  $default,){
final _that = this;
switch (_that) {
case _WebsocketEventUpdated():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebsocketEventUpdated value)?  $default,){
final _that = this;
switch (_that) {
case _WebsocketEventUpdated() when $default != null:
return $default(_that);case _:
