...
/// Adds pattern-matching-related methods to [WebsocketStopReceivePosition].
extension WebsocketStopReceivePositionPatterns on WebsocketStopReceivePosition {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebsocketStopReceivePosition value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebsocketStopReceivePosition value)  $default,){
final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebsocketStopReceivePosition value)?  $default,){
final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type, @JsonKey(name: "user")  int userId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type, @JsonKey(name: "user")  int userId)  $default,) {final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition():
return $default(_that.type,_that.userId);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type, @JsonKey(name: "user")  int userId)?  $default,) {final _that = this;
switch (_that) {
case _WebsocketStopReceivePosition() when $default != null:
return $default(_that.type,_that.userId);case _:
  return null;
