...
/// Adds pattern-matching-related methods to [WebsocketSubscribed].
extension WebsocketSubscribedPatterns on WebsocketSubscribed {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _WebsocketSubscribed value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _WebsocketSubscribed() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _WebsocketSubscribed value)  $default,){
final _that = this;
switch (_that) {
case _WebsocketSubscribed():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _WebsocketSubscribed value)?  $default,){
final _that = this;
switch (_that) {
case _WebsocketSubscribed() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool subscribed,  String type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WebsocketSubscribed() when $default != null:
return $default(_that.subscribed,_that.type);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool subscribed,  String type)  $default,) {final _that = this;
switch (_that) {
case _WebsocketSubscribed():
return $default(_that.subscribed,_that.type);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool subscribed,  String type)?  $default,) {final _that = this;
switch (_that) {
case _WebsocketSubscribed() when $default != null:
return $default(_that.subscribed,_that.type);case _:
  return null;
